  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        console.log(that.data, res, "options_ID1", that.data.items)
      }
    });
    //ajax请求数据
  },
...
//     console.log('bindTextAreaBlur1 change，携带的value值', e.detail.value)
//     var that = this
//     // var content = 'record.content'
//     var summary = 'items.summary'
//     that.setData({
...
//     })
//   },
// //对应fruit，应该是提交new fruit，模板里命名如此了，未改
...
//               summary:that.data.items.summary
//             }
//           },
//           header: {
//             'Content-Type': 'application/json'
